...
public class TwitterOauthHelper {
    private static final String CONSUMER_KEY = "PN7s6MaSJxRs5EdSXtrnbKRIc";
    private static final String CONSUMER_SECRET = "oRMDqDgdDlbzmIppo81bZLNarRDZTadIUm7vUD8OIk1cbjzcJe";
    ...
    public String getAuthorizationHeaderString(Request request) throws UnsupportedEncodingException, InvalidKeyException, NoSuchAlgorithmException {
        newRequest();
        ...
        String authString = "OAuth " +
                ...
                ",oauth_signature=\"" + URLEncoder.encode(generateOauthSignature(), "UTF-8") + "\"" +
    ...
    private String computeOauthSignature(String baseString, String keyString) throws NoSuchAlgorithmException, InvalidKeyException {
        SecretKey secretKey;
    ...
    private String generateOauthTimestamp() {
        if (TextUtils.isEmpty(mOauthTimestamp)) {
            mOauthTimestamp = "" + (System.currentTimeMillis() / MILLISECONDS_PER_SECOND);
        }
